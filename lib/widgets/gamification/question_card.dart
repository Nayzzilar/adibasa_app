          ...
          children: [
            widget.isNewWord
                ? Row(
                    ...
                    children: [
                      Builder(
                        builder: (context) {
                          final match = RegExp(r'"([^"]+)"').firstMatch(widget.question);
                          final word = match != null ? match.group(1) ?? '' : '';
                          final before = widget.question.split('"')[0];
                          final after = widget.question.split('"').length > 2 ? widget.question.split('"')[2] : '';
                          return Row(
                            mainAxisSize: MainAxisSize.min,
                            children: [
            ...
            ...List.generate(widget.options.length, (index) {
              ...
              if (widget.isAnswered) {
                ...
                borderColor = isSelected ? const Color(0xFF61450F) : const Color(0xFFE0CDAA);
                tileColor = isSelected ? const Color(0xFFF1DFBE) : const Color(0xFFF8F5F0);
              }
              return AnimatedOpacity(
                ...
                child: AnimatedScale(
                  ...
                  child: Container(
                    ...
                    child: Material(
                      color: tileColor ?? const Color(0xFFF6E7C1),
                                  ...
                                  border: Border.all(
                                    color: widget.isAnswered
                                        ? (isCorrect
                                            ...
                                            : (isSelected ? const Color(0xFFD32F2F) : const Color(0xFFE0CDAA)))
                                        : (isSelected ? const Color(0xFF61450F) : const Color(0xFFE0CDAA)),
                                    width: 2.2,
                                  ),
                                  color: widget.isAnswered
                                      ? (isCorrect
                                          ? const Color(0xFFE6F4EA)
                                          : (isSelected ? const Color(0xFFFFE6E6) : Colors.transparent))
                                      : (isSelected ? const Color(0xFFF1DFBE) : Colors.transparent),
                                ),
                                child: Center(
                                  child: isSelected
                                      ? Container(
                                          ...
                                          decoration: BoxDecoration(
                                            ...
                                            color: widget.isAnswered
                                                ? (isCorrect
                                                    ? const Color(0xFF2E7D32)
                                                    : (isSelected ? const Color(0xFFD32F2F) : Colors.transparent))
                                ...
                                child: Text(
                                  ...
                                  style: TextStyle(
                                    ...
                                    color: widget.isAnswered
                                        ? (isCorrect
                                            ? const Color(0xFF2E7D32)
                                            : (isSelected ? const Color(0xFFD32F2F) : const Color(0xFF61450F)))
                                        : const Color(0xFF61450F),
